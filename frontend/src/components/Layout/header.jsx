  ...
  const drawer = (
    <div className="text-center">
      <div className="py-2 bg-primary d-flex justify-content-between align-items-center">
        ...
        />
        <i
          className="bi bi-x text-white me-2"
      ...
      <ul className="list-unstyled">
        <li
          className="p-2 bg-info text-center"
    ...
    <div className="d-flex">
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary w-100">
        <div className="container-fluid flex-nowrap">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <div className="ms-auto d-none d-sm-flex justify-content-center align-items-center">
      ...
      <nav>
        <div
          ...
          tabIndex="-1"
        >
          <div className="offcanvas-body">{drawer}</div>
        </div>
      </nav>
    </div>
  );
